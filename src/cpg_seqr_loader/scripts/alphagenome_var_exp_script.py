...
organs = config.config_retrieve(['alphagenome_parm','organs'], default=[
...
gtf= config.config_retrieve(['alphagenome_parm', 'gtf'], default='gs://cpg-common-main/references/alphagenome/gencode.v46.annotation.gtf.gz.feather')
...
def build_parser() -> argparse.ArgumentParser:
    ...
    P.add_argument("--output-table", default="gs://cpg-kidgen-test/alphagenome_scan_results.csv",
                   help="Output summary table path (csv/tsv/xlsx).")
    P.add_argument("--output-table-sum", default="gs://cpg-kidgen-test/alphagenome_scan_results_variant_organ_summary.csv",
